    ...
    var item = function() {
        switch (num) {
          case 0:
            ...
            block[1] = [ [ 4, -2 ], [ 4, -1 ], [ 4, 0 ], [ 4, 1 ] ];
            block[2] = [ [ 3, -1 ], [ 4, -1 ], [ 5, -1 ], [ 6, -1 ] ];
            block[3] = [ [ 4, -2 ], [ 4, -1 ], [ 4, 0 ], [ 4, 1 ] ];
            break;

          case 1:
            block[0] = [ [ 3, -1 ], [ 3, 0 ], [ 4, 0 ], [ 5, 0 ] ];
            block[1] = [ [ 4, -1 ], [ 5, -1 ], [ 4, 0 ], [ 4, 1 ] ];
            block[2] = [ [ 3, -1 ], [ 4, -1 ], [ 5, -1 ], [ 5, 0 ] ];
            block[3] = [ [ 4, -1 ], [ 4, 0 ], [ 3, 1 ], [ 4, 1 ] ];
            break;

          case 2:
            block[0] = [ [ 5, -1 ], [ 3, 0 ], [ 4, 0 ], [ 5, 0 ] ];
            block[1] = [ [ 4, -1 ], [ 4, 0 ], [ 4, 1 ], [ 5, 1 ] ];
            block[2] = [ [ 3, -1 ], [ 4, -1 ], [ 5, -1 ], [ 3, 0 ] ];
            block[3] = [ [ 3, -1 ], [ 4, -1 ], [ 4, 0 ], [ 4, 1 ] ];
            break;
          ...
          case 4:
            block[0] = [ [ 4, -1 ], [ 5, -1 ], [ 3, 0 ], [ 4, 0 ] ];
            block[1] = [ [ 4, -1 ], [ 4, 0 ], [ 5, 0 ], [ 5, 1 ] ];
            block[2] = [ [ 4, -1 ], [ 5, -1 ], [ 3, 0 ], [ 4, 0 ] ];
            block[3] = [ [ 4, -1 ], [ 4, 0 ], [ 5, 0 ], [ 5, 1 ] ];
            break;

          case 5:
            block[0] = [ [ 3, -1 ], [ 4, -1 ], [ 4, 0 ], [ 5, 0 ] ];
            block[1] = [ [ 4, -1 ], [ 3, 0 ], [ 4, 0 ], [ 3, 1 ] ];
            block[2] = [ [ 3, -1 ], [ 4, -1 ], [ 4, 0 ], [ 5, 0 ] ];
            block[3] = [ [ 4, -1 ], [ 3, 0 ], [ 4, 0 ], [ 3, 1 ] ];
            break;

          case 6:
            block[0] = [ [ 4, -1 ], [ 3, 0 ], [ 4, 0 ], [ 5, 0 ] ];
            block[1] = [ [ 4, -1 ], [ 4, 0 ], [ 5, 0 ], [ 4, 1 ] ];
            block[2] = [ [ 3, -1 ], [ 4, -1 ], [ 5, -1 ], [ 4, 0 ] ];
            block[3] = [ [ 4, -1 ], [ 3, 0 ], [ 4, 0 ], [ 4, 1 ] ];
            break;
        }
    }();
    return {
